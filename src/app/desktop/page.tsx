...
import ConversationsClient from '../workspace/conversations/ConversationsClient';
...
export default async function DesktopPage() {
  ...
  return (
    <div className="w-screen h-screen flex flex-col overflow-hidden bg-[#0e0f11]">
      {/* Top Header: Organization Switcher, Task Dropdown, Real-time Start/Stop Time Tracker */}
      <DesktopHeader />

      {/* Main Body: Integrated Real-time Web Chat */}
