...
const pages = [
  ...
  { path: 'guides', title: 'Guides & E-books' },
  { path: 'api-docs', title: 'API Documentation' },
  { path: 'careers', title: 'Careers' },
  { path: 'press', title: 'Press & Media Kit' },
  ...
  { path: 'compare-plans', title: 'Compare Plans' },
];
      ...
      <section className="relative min-h-[70vh] overflow-hidden bg-[#fbfaf7] text-[#151515] flex flex-col pt-32">
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1180px] px-6 flex-1">
          ...
          <div className="max-w-3xl space-y-6 text-lg text-black/70">
            <p>
              This is the ${title} page. Content is currently being updated and will be available soon.
            </p>
            <p>
...
pages.forEach(page => {
  ...
  fs.writeFileSync(path.join(dirPath, 'page.tsx'), template(page.title));
  console.log(`Generated ${page.path}/page.tsx`);
});
